package com.nhom13.security.jwt;
...
public class CustomAccessDeniedHandler implements AccessDeniedHandler {
	...
	public void handle(HttpServletRequest request, HttpServletResponse response,
		...
		response.getOutputStream().write(String.format(
				...
				new ObjectMapper().writer().withDefaultPrettyPrinter().writeValueAsString(new AccessDeniedExceptionInfo(accessDeniedException))).getBytes(StandardCharsets.UTF_8));
